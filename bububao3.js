...
async function all() {
    ...
    for (let i = 0; i < Length; i++) {
        ...
        header = {
            ...
            'version': `10`,
            'idfa': `12709E4F-C619-4CEA-A54C-AD6D9A25478C`,
            'Content-Type': `application/x-www-form-urlencoded`,
            'User-Agent': `BBB/132 CFNetwork/978.0.7 Darwin/18.7.0`,
            'platform': `2`,
            'imei': `D48026EE-BF13-44D1-A1AA-5BE53B929A51`,
            'Cookie': `PHPSESSID=5ve79b0l0jcl4sgu5fvr24aqq0`,
