...
############## 圈x
#步步宝获取TOKEN
https:\/\/bububao\.duoshoutuan\.com\/user\/* url script-request-header https://raw.githubusercontent.com/6Svip120apk69/gitee_q8qsTAUA_cThxc1RBVUE/master/Task/bububao.js
...
async function all() {
    ...
    for (let i = 0; i < Length; i++) {
        ...
        header = {
            ...
            'version': `10`,
            'idfa': `D693343F-E239-4ED4-A4C5-91D3CD206020`,
            'Content-Type': `application/x-www-form-urlencoded`,
            'User-Agent': `BBB/132 CFNetwork/1125.2 Darwin/19.4.0`,
            'platform': `2`,
            'imei': `F0E1CEB5-D1A6-45AB-A3EA-68FB351AB5A5`,
            'Cookie': `PHPSESSID=qo39oo19n3objojpvu54eeunt0`,
